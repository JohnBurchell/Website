...
//Setup the buckets for the maps, removed some allocations and other changes.
//Using manhattan with the weighted "nudge" as I have a feeling it's failing on very large open map. (I had better times with this on large open maps in my tests)
...
public:
	...
	//Testing to see if maybe it's being called in other threads or something? Bit of a stab in the dark...Quite unfamiliar with multi-threaded searching etc
	bool m_lock;
};
...
{
	//Could possibly pre-allocate these too?
